...
/* =====================================================
   10. AIRLINE DATABASE
   TRAVELMATE AIRLINE MATCHING SYSTEM
   ===================================================== */
...
const airlineDatabase = [

    {
        ...
        reason: {
            de: "Hervorragende Gesamtqualität, starke Economy und eine besonders starke Business Class.",
            en: "Excellent overall quality, strong Economy and an outstanding Business Class."
        }
    },
...

    {
        ...
        reason: {
            de: "Sehr hoher Service- und Komfortstandard mit besonders starker Economy und Business Class.",
            en: "Very high service and comfort standards with especially strong Economy and Business Class products."
        }
    },
...

    {
        ...
        reason: {
            de: "Sehr guter Komfort, umfangreiches Entertainment und starke Langstreckenleistung.",
            en: "Excellent comfort, extensive entertainment and a strong long-haul experience."
        }
    },
...

    {
        ...
        reason: {
            de: "Besonders starke Wahl für Japan mit sehr gutem Service und hohem Komfort.",
            en: "An especially strong choice for Japan with excellent service and high comfort."
        }
    },
...

    {
        ...
        reason: {
            de: "Sehr gute Kombination aus Komfort, Service und Qualität für Asien- und Langstreckenreisen.",
            en: "A very strong combination of comfort, service and quality for Asian and long-haul travel."
        }
    },
...

    {
        ...
        reason: {
            de: "Sehr gutes Preis-Leistungs-Verhältnis und ein besonders großes internationales Streckennetz.",
            en: "Excellent value for money and an exceptionally large international route network."
        }
    },
...

    {
        ...
        reason: {
            de: "Starke Premium-Option mit sehr guter Business Class und hohem Komfort.",
            en: "A strong premium option with an excellent Business Class and high comfort."
        }
    },
...

    {
        ...
        reason: {
            de: "Besonders praktisch für Reisende ab Deutschland und Frankfurt mit starkem europäischen Netzwerk.",
            en: "Especially convenient for travelers from Germany and Frankfurt with a strong European network."
        }
    },
...

    {
        ...
        reason: {
            de: "Starke Wahl über Paris mit guter Kombination aus Service, Komfort und Langstreckenangebot.",
            en: "A strong option via Paris with a good combination of service, comfort and long-haul capability."
        }
    },
...

    {
        ...
        reason: {
            de: "Solide Allround-Airline mit gutem europäischen und internationalen Netzwerk.",
            en: "A solid all-round airline with a strong European and international network."
        }
    }
...
function getAirlinePriorityName(priority) {
...
function calculateAirlineMatch(
    ...
    return (
        ...
        airline.economy *
        selectedWeights.economy

        +

        airline.business *
        selectedWeights.business

        +

        airline.comfort *
        selectedWeights.comfort
...
function getMatchQuality(score) {
    ...
    if (score >= 9.5) {
        ...
        return {
            de: "Hervorragende Übereinstimmung",
            en: "Excellent match"
        };
...
function findAirlines() {
    ...
    /*
     * Nur Airlines berücksichtigen,
     * die das gewählte Ziel in unserer
     * Datenbank bedienen.
     */
    ...
    results.innerHTML = `
        ...
        <div class="airline-results-header">
...
/* =====================================================
   UPDATE AIRLINE FINDER LANGUAGE
   ===================================================== */
...
function updateAirlineFinderLanguage() {
    ...
    /*
     * Wenn bereits Ergebnisse angezeigt
     * werden, werden sie mit der neuen
     * Sprache neu aufgebaut.
     */
