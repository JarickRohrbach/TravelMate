...
function updateAirlineFinderLanguage() {
    ...
    if (priority) {
        ...
        if (priority.options[0])
            priority.options[0].text =
                t.bestOverall;

        if (priority.options[1])
            priority.options[1].text =
                t.bestValue;

        if (priority.options[2])
            priority.options[2].text =
                t.bestEconomy;

        if (priority.options[3])
            priority.options[3].text =
                t.bestBusiness;

        if (priority.options[4])
            priority.options[4].text =
                t.bestComfort;

        if (priority.options[5])
            priority.options[5].text =
                t.bestWifi;

        if (priority.options[6])
            priority.options[6].text =
                t.bestConnections;
    ...
    /* If results are already visible,
       redraw them in the new language. */
...
/* =========================================================
   31. ACCOUNT MODAL OUTSIDE CLICK
   ========================================================= */
