...
function localTimeToUTC(
  ...
  /*
   * Start by treating the entered local
   * time as UTC.
   */
  ...
  /*
   * Two or more iterations handle DST
   * changes much more reliably than using
            ...
            <div class="airline-result">
              ...
              <div class="airline-info">
                ...
                <div class="airline-rating">
                  ${t().rating}: ${airline.rating}/5 · ${airlineScore(airline.name,priority)}/100
                </div>
